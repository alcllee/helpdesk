...
// --> General settings
$hesk_settings['site_title']='AlanCom';
$hesk_settings['site_url']='http://localhost';
$hesk_settings['support_mail']='admin@alanlee.my';
$hesk_settings['webmaster_mail']='admin@alanlee.my';
$hesk_settings['noreply_mail']='admin@alanlee.my';
$hesk_settings['noreply_name']='AlanCom Help Desk';
...
$hesk_settings['db_pass']='p4ssw0rd';
...
$hesk_settings['server_path']='C:/xampp/htdocs/helpdesk';
...
$hesk_settings['secimg_sum']='PG92THW4HH';
...
'custom1'=>array('use'=>1,'place'=>0,'type'=>'radio','req'=>1,'name'=>'Department','maxlen'=>255,'value'=>'Accounting#HESK#Marketing#HESK#IT Software#HESK#IT Hardware#HESK#IT System Engineering'),
